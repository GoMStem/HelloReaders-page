...
export default function Page() {
  ...
  const curriculumData = {
    ko: {
      ...
      debating: [
        { title: "Read Current Issues", description: "다양한 저널을 읽고\n주제에 대한 이해를 넓힙니다." },
        { title: "Discuss Different Perspectives", description: "다양한 관점으로 토론하고 사고를 확장합니다." },
        { title: "Build Logical Arguments", description: "논리적으로 정리하고\n근거를 바탕으로\n생각을 발전시킵니다." },
        { title: "Structured Essay Writing", description: "논리적인 글쓰기 능력을 기릅니다." },
      ],
      maths: [
    ...
    <div className="min-h-screen" style={{ backgroundColor: colors.background }}>
      ...
      >
        ...
        <div className="flex justify-between items-center mb-8">
          <img src="/logo.png" alt="Hello Readers" style={{ height: '32px', width: 'auto' }} />
          <button
            onClick={() => setDrawerOpen(false)}
